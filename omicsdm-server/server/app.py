...
from server.apis.analysis import ns as ns_analysis  # noqa: E402
...
api.add_namespace(ns_analysis, path="/api/analysis")
...
def test_celery():
    my_task.delay()
    return "Test Task has been started!", 200
...
# only comment below in if you want to write swagger.json
# otherwise the API will not be reachable
